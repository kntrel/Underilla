...
final class BlockColors {
    ...
    static final Color AIR = new Color(0xD9F1FF);

    private static final Color UNKNOWN = new Color(0xE433A3);
    private static final Map<ID, Color> COLORS = Map.ofEntries(
            Map.entry(ID.of("minecraft:air"), AIR),
            Map.entry(ID.of("minecraft:cave_air"), AIR),
            Map.entry(ID.of("minecraft:void_air"), AIR),
            ...
            Map.entry(ID.of("minecraft:coarse_dirt"), new Color(0x70513B)),
            Map.entry(ID.of("minecraft:grass_block"), new Color(0x6FA449)),
            Map.entry(ID.of("minecraft:grass"), new Color(0x6FAF45)),
            Map.entry(ID.of("minecraft:tall_grass"), new Color(0x649C3F)),
            Map.entry(ID.of("minecraft:fern"), new Color(0x4E7F32)),
            Map.entry(ID.of("minecraft:large_fern"), new Color(0x47762E)),
            ...
            Map.entry(ID.of("minecraft:cobblestone"), new Color(0x777777)),
