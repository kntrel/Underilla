...
/** Historical block-copying implementation retained only as a characterization-test oracle. */
final class LegacyReferenceWorldPatcher implements Patcher<ChunkData> {
