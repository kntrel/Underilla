...
class PatchersReferenceWorldEntityTest {
    ...
    void copiesEntitiesFromTheCorrespondingReferenceChunk() {
        ...
        Patcher<ChunkData> patcher = Patchers.referenceWorldEntityPatcher(
    ...
    void doesNothingWhenTheReferenceChunkIsMissing() {
        ...
        Patchers.referenceWorldEntityPatcher(new TestWorld()).patch(target);
